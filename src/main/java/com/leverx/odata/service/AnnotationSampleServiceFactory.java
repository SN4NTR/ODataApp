...
import static org.apache.olingo.odata2.annotation.processor.api.AnnotationServiceFactory.createAnnotationService;
...
public class AnnotationSampleServiceFactory extends ODataServiceFactory {
    ...
    static {
        try {
            annotationODataService = createAnnotationService(MODEL_PACKAGE);
